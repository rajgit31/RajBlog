<%@ Control Language="C#" AutoEventWireup="true" CodeFile="edit.ascx.cs" Inherits="widgets_TwitterSearch_edit" %>
<%@ Reference Control="~/widgets/TwitterSearch/widget.ascx" %>
<asp:Label for="<%=searchTerm%>" ID="searchTermLabel" runat="server" Text="Search Term"></asp:Label><br />
<asp:TextBox ID="searchTerm" runat="server"></asp:TextBox>
<asp:RequiredFieldValidator ID="searchTermValidator" ControlToValidate="searchTerm" runat="server" ErrorMessage="Required" Display="dynamic"></asp:RequiredFieldValidator>
<br /><br />
